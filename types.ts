...
export interface InteractiveTasksPayload {
    title: string;
    tasks: { day: string, subject: string, text: string, completed: boolean }[];
}

export type ChatResponseType = 'text' | 'schedule' | 'tasks';

export type ChatPayload = string | InteractiveSchedulePayload | InteractiveTasksPayload;
