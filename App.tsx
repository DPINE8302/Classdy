...
import { Settings as SettingsIcon, LayoutGrid, ListChecks, AreaChart, BarChartHorizontal, Plus, MessageSquare } from 'lucide-react';
...
const NAV_OPTIONS = [
    ...
    {label: 'Chat', value: 'chat' as Tab, icon: MessageSquare},
];
