...
export const MobileNav: React.FC<MobileNavProps> = ({ options, activeTab, onTabChange }) => {
    return (
        <footer className="fixed bottom-0 left-0 right-0 h-16 pb-[env(safe-area-inset-bottom)] box-content bg-white/80 dark:bg-zinc-900/80 backdrop-blur-lg border-t border-zinc-200 dark:border-zinc-800 z-40">
